<%-- 
    Document   : customeradminprofile
    Created on : Aug 23, 2017, 7:55:48 PM
    Author     : Bidesh
--%>
...
function googleTranslateElementInit() {
 ...
 <center>
        ...
        <table id="t1" border="1">
            ...
            <tr>
                <td><c:out value="${uinfo.email}"/></td>
                <td><c:out value="${uinfo.firstname}"/></td>
                <td><c:out value="${uinfo.lastname}"/></td>
                <td><c:out value="${uinfo.ph}"/></td>
                <td><c:out value="${uinfo.dobDate}"/></td>
                <td><c:out value="${uinfo.address}"/></td>
                <td><c:out value="${uinfo.password}"/></td>
                <td><a href="editinfo.htm?id=${uinfo.email}"><font color="red">Edit</a> </td>
              </tr>
            </c:forEach>
        </table>
