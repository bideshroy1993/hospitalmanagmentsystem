<%-- 
    Document   : sucssappoadd
    Created on : Aug 16, 2017, 7:19:40 PM
    Author     : Bidesh
--%>
...
<html>
    <head>
        ...
        <title>Slot Add successfully</title>
        <script>
function openNav() {
...
<div id="welcomeadmin">
    <h1>Appointment Slot Add successfully</h1>
    <br>
    <h3><a href="opt.htm"><input type="submit" value="Click Here to view details" class="button" /></a></h3>
</div>
        </div>
          <div id="footerpart">
      <footer>
