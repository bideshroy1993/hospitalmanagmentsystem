<%-- 
    ...
    Created on : Aug 16, 2017, 1:48:33 PM
    Author     : Bidesh
--%>
...
function googleTranslateElementInit() {
 ...
 <center>
        ...
        <table id="t1" border="1">
            ...
            <c:forEach items="${us}" var="Admin">
                <tr>
                    <td><c:out value="${Admin.adminId}"/></td>
                    <td><c:out value="${Admin.username}"/></td>
                    <td><c:out value="${Admin.password}"/></td>
                   
                    <td><a href="deleteadmin.htm?id=${Admin.adminId}"><font color="red">Delete</a></td> 
                </tr>  
            </c:forEach>
                
            
        </table>
          <h3><a href="addadmin.htm">Click Here</a> to add New Admin</h3>
    </center>
        </div>
        </div>
        <div id="clear"></div>
