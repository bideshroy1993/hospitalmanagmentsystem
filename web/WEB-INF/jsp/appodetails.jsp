<%-- 
    Document   : optdetails
    Created on : Jul 22, 2017, 11:50:00 AM
    Author     : Bidesh
--%>
     ...
     <center>
        ...
        <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:black;font-style:italic;">
            ...
            <tr>
                ...
                <td><a href="editappo.htm?id=${Appointment.appoId}"><font color="white">Edit</a> </td> 
                 <td><a href="deleteappo.htm?id=${Appointment.appoId}"><font color="white">Delete</a> </td> 
                </tr>
            </c:forEach>
        </table>
        <br><br>
                <h3><a href="addappointment.htm">Click Here</a> to add appointment slot</h3>
    </center>
        </div>
         <div id="details2">
         <center>
