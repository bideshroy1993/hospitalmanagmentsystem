<%-- 
    Document   : updateeditappo
    Created on : Aug 8, 2017, 2:57:00 AM
    Author     : Bidesh
--%>
...
<center>
         <h1>${message}</h1><br>
        <c:choose>
            <c:when test="${not empty uappo}">
                <div id="search_id" >
                <form action="updateappo.htm" method="post">
                   <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:red;font-style:italic;">
                    <c:forEach items="${uappo}" var="Appo">
                                         
                    
                    <tr>
                         <td>Appointment ID</td>
                         <td><input type="text" name="idd" value="${Appo.appoId}"></td>
                     </tr>
                      <tr>
                         <td>Doctor ID</td>
                         <td><input type="text" name="docid" value="${Appo.docId}"></td>
                     </tr>
                     <tr>
                         <td>Day</td>
                         <td>
                             <select name="day" value="${Appo.day}">
                     ...
                     <tr>
                         <td>Time</td>
                         <td>
                             <select name="time" value="${Appo.time}">
                                 <option>9:00AM-11:30AM</option>
                                 <option>6:00PM-10:00PM</option>
                             </select>
                         </td>
                     </tr>  
                 </c:forEach>
         ...
         <a href="opt.htm">Click Here</a> to view the details.
    </center>
        </div>
        </div>
        <div id="clear"></div>
