<%-- 
    Document   : updatuinfosuccs
    Created on : Aug 23, 2017, 8:44:30 PM
    Author     : Bidesh
--%>
...
<div id="welcomeadmin">
    ...
    <br>
    <h3><a href="customerdata.htm"><input type="submit" value="Click Here to view details" class="button" /></a></h3>
</div>
        </div>
          <div id="footerpart">
      <footer>
