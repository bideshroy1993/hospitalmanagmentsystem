<%-- 
    Document   : updateedituinfo
    Created on : Aug 23, 2017, 8:17:47 PM
    Author     : Bidesh
--%>
...
<center>
         <h1>${message}</h1><br>
        <c:choose>
            <c:when test="${not empty uinfo}">
                <div id="search_id" >
                <form action="updateuinfo.htm" method="post">
                   <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:black;font-style:italic;">
                    <c:forEach items="${uinfo}" var="uinfo">
                    ...
                    <tr>
                      ...
                      <tr>
                         <td>First Name</td>
                         <td><input type="text" name="fnm" value="${uinfo.firstname}"></td>
                     </tr>
                     <tr>
                         <td>Last Name</td>
                         <td><input type="text" name="lnm" value="${uinfo.lastname}"></td>
                     </tr>  
                     <tr>
                         <td>Phone No.</td>
                         <td><input type="text" name="ph" value="${uinfo.ph}"></td>
                     </tr> 
                      
                     <tr>
                         <td>Date of Birth</td>
                         <td><input id="dob" type="text" name="dob" value="${uinfo.dobDate}"></td>
                         <td><h4>mm dd yyyy</h4></td>
                     </tr>
                     <tr>
                         <td>Address</td>
                         <td><input type="text" name="address" value="${uinfo.address}"></td>
                     </tr>
                     <tr>
                         <td>Password</td>
                         <td><input type="text" name="pass" value="${uinfo.password}"></td>
                     </tr>
                 </c:forEach>
                 </table><br/>
         ...
         <a href="customerdata.htm">Click Here</a> to get Details Page.
    </center>
        </div>
        </div>
        <div id="clear"></div>
