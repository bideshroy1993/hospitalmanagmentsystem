<%-- 
    Document   : addnewopt
    Created on : Jul 25, 2017, 8:32:59 AM
    Author     : Bidesh
--%>
...
<html>
    <head>
        ...
        <title>Add New Appointment Slot</title>
          <script>
function openNav() {
...
function googleTranslateElementInit() {
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
   ...
   <br><br>
    <a href="opt.htm">Click Here</a> to get previous Page.
        </center>
        </div>
        </div>
        <div id="clear"></div>
