<%-- 
    Document   : updatediagsuccs
    Created on : Aug 6, 2017, 6:41:13 PM
    Author     : Bidesh
--%>
...
<div id="welcomeadmin">
    ...
    <br>
    <h3><a href="diag.htm"><input class="button" type="submit" value="Click Here to view details" class="button" /></a></h3>
</div>
        </div>
          <div id="footerpart">
      <footer>
