<%-- 
    Document   : docdetails
    Created on : Jul 22, 2017, 12:01:49 PM
    Author     : Bidesh
--%>
...
function googleTranslateElementInit() {
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
        ...
        <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:black;font-style:italic;">
            ...
            <c:forEach items="${udoc}" var="Doctor">
            <tr>
                <td><c:out value="${Doctor.docId}"/></td>
                <td><c:out value="${Doctor.docName}"/></td>
                <td><c:out value="${Doctor.deptId}"/></td>
                <td><c:out value="${Doctor.qualification}"/></td>
                <td><a href="editdoc.htm?id=${Doctor.docId}"><font color="red">Edit</a> </td> 
                <td><a href="deletedoc.htm?id=${Doctor.docId}"><font color="red">Delete</a> </td>
                </tr>
            </c:forEach>
               
                
        </table>
               <a href="adddoc.htm">Click Here</a> to add new Doctor.
          </center>
        </div>
          <div id="details2">
              <center>
         <table id="t1" border="1">
            ...
            <c:forEach items="${udept}" var="depertment">
            <tr>
                <td><c:out value="${depertment.deptId}"/></td>
                <td><c:out value="${depertment.deptName}"/></td>
              </tr>
            </c:forEach>
        </table>
              </center>
