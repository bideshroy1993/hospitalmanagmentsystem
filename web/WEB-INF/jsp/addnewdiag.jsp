<%-- 
    Document   : addnewdiag
    Created on : Jul 25, 2017, 10:50:11 AM
    Author     : Bidesh
--%>
...
<html>
    <head>
        ...
        <title>Add New Diagnosis Type</title>
         <script>
function openNav() {
...
function googleTranslateElementInit() {
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
    ...
    <h1>${message}</h1><br>
   <form action="succadddiag.htm" method="get">
              <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:red;font-style:italic;">
                  <tr>
                      <td>Diagnosis ID</td>
                      <td><input type="text" name="diagid" required></td>
                  </tr>
            <tr>
                <td>Diagnosis Name</td>
                <td><input type="text" name="diagnm" required></td>
            </tr>
             <tr>
                <td>Price</td>
                <td><input type="text" name="diagprice" required></td>
            </tr>
                <td></td>
    ...
    <a href="diag.htm">Click Here</a> to get previous Page.
        </center>
        </div>
        </div>
        <div id="clear"></div>
