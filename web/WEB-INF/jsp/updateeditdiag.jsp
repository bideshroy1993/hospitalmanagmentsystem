<%-- 
    Document   : updateeditdiag
    Created on : Aug 6, 2017, 3:46:35 PM
    Author     : Bidesh
--%>
   ...
   <center>
        ...
        <c:choose>
            <c:when test="${not empty us}">
                <div id="search_id" >
                <form action="updatediag.htm" method="post">
                   <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:red;font-style:italic;">
                    ...
                    <tr>
                         <td>Diagnosis ID</td>
                         <td><input type="text" name="idd" value="${DiagnosisType.diagId}"></td>
                     </tr>
                      <tr>
                         <td>Diagnosis Type</td>
                         <td><input type="text" name="nm" value="${DiagnosisType.diagType}"></td>
                     </tr>
                     <tr>
                         <td>Price</td>
                         <td><input type="text" name="price" value="${DiagnosisType.price}"></td>
                     </tr>     
                 </c:forEach>
                 </table><br/>
         ...
         <a href="diag.htm">Click Here</a> to get  Details.
    </center>
        </div>
        </div>
        <div id="clear"></div>
