<%-- 
    Document   : diagappointment
    Created on : Aug 3, 2017, 9:58:13 AM
    Author     : Bidesh
--%>
...
<html>
    <head>
        ...
        <title>All Diagnosis Appointment</title>
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
     ...
     <center>
        ...
        <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:black;font-style:italic;">
            ...
            <c:forEach items="${us}" var="customer">
            <tr>
                <td><c:out value="${customer.mrNo}"/></td>
                <td><c:out value="${customer.customerName}"/></td>
                <td><c:out value="${customer.contactNo}"/></td>
                <td><c:out value="${customer.daigName}"/></td>
                <td><a href="editdiagappo.htm?id=${customer.mrNo}"><font color="red">Edit</a></td>
                <td><a href="deletediagappo.htm?id=${customer.mrNo}"><font color="red">Delete</a></td> 
                </tr>
            </c:forEach>
        </table> 
    </center>
