<%-- 
    Document   : diagnosis
    Created on : Jul 22, 2017, 12:18:19 PM
    Author     : Bidesh
--%>
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
   ...
   <center>
        ...
        <table id="t1" border="1">
            ...
            <c:forEach items="${us}" var="DiagnosisType">
                <tr>
                    <td><c:out value="${DiagnosisType.diagId}"/></td>
                    <td><c:out value="${DiagnosisType.diagType}"/></td>
                    <td><c:out value="${DiagnosisType.price}"/></td>
                    <td><a href="editdiag.htm?id=${DiagnosisType.diagId}"><font color="red">Edit</a></td>
                    <td><a href="deletediag.htm?id=${DiagnosisType.diagId}"><font color="red">Delete</a></td> 
                </tr>  
            </c:forEach>
                
            
        </table>
          <h3><a href="adddiag.htm">Click Here</a> to add New Diagnosis Type</h3>
    </center>
        </div>
        </div>
        <div id="clear"></div>
