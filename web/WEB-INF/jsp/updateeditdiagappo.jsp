<%-- 
    Document   : updateeditdiagappo
    Created on : Aug 8, 2017, 3:53:28 AM
    Author     : Bidesh
--%>
...
<center>
        ...
        <c:choose>
            <c:when test="${not empty us}">
                <div id="search_id" >
                <form action="updatecustomerdiag.htm" method="post">
                   <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:red;font-style:italic;">
                    <c:forEach items="${us}" var="diagappo">
                                         
                    
                    <tr>
                         <td>MR. Number</td>
                         <td><input type="text" name="idd" value="${diagappo.mrNo}"></td>
                     </tr>
                      <tr>
                         <td>Customer Name</td>
                         <td><input type="text" name="nm" value="${diagappo.customerName}"></td>
                     </tr>
                     <tr>
                         <td>Contact No.</td>
                         <td><input type="text" name="ph" value="${diagappo.contactNo}"></td>
                     </tr>  
                     <tr>
                         <td>Diagnosis Name</td>
                         <td><input type="text" name="daigName" value="${diagappo.diagName}"></td>
                     </tr>  
                 </c:forEach>
                 </table><br/>
         ...
         <a href="diagappo.htm">Click Here</a> to get Diagnosis Appointment Details.
    </center>
        </div>
        </div>
        <div id="clear"></div>
