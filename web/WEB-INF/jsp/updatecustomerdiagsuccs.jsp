<%-- 
    Document   : updatecustomerdiagsuccs
    Created on : Aug 8, 2017, 8:51:27 AM
    Author     : Bidesh
--%>
...
<div id="welcomeadmin">
    ...
    <br>
    <h3><a href="diagappo.htm"><input type="submit" value="Click Here to view details" class="button" /></a></h3>
</div>
        </div>
          <div id="footerpart">
      <footer>
