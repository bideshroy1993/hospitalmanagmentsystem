<%-- 
    Document   : updatecustomerapposuccs
    Created on : Aug 8, 2017, 11:17:13 AM
    Author     : Bidesh
--%>
...
<div id="welcomeadmin">
    ...
    <br>
    <h3><a href="customerappo.htm"><input type="submit" value="Click Here to view details" class="button" /></a></h3>
</div>
        </div>
          <div id="footerpart">
      <footer>
