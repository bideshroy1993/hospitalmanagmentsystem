<%-- 
    ...
    Created on : Jul 30, 2017, 2:56:26 AM
    Author     : Bidesh
--%>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'bn,en,hi,zh-CN'}, 'google_translate_element');
        ...
        <div id="bodypart">
            <div id="booksuccess">
            <h1>Your Booking is successfully Recorded</h1>
            <br><br>
            <a href="userbooking.htm"><input class="button" type="submit" value="Click Here to Book another Appointment" /></a>
        </div>
        </div>
                            <div id="clear">
        </div>
