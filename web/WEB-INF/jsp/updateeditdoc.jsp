<%-- 
    Document   : updateeditdoc
    Created on : Aug 8, 2017, 1:46:20 AM
    Author     : Bidesh
--%>
...
<center>
         <h1>${message}</h1><br>
        <c:choose>
            <c:when test="${not empty udoc}">
                <div id="search_id" >
                <form action="updatedoc.htm" method="post">
                   <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:red;font-style:italic;">
                    ...
                    <tr>
                         <td>Doctor ID</td>
                         <td><input type="text" name="idd" value="${Doctor.docId}"></td>
                     </tr>
                      <tr>
                         <td>Doctor Name</td>
                         <td><input type="text" name="nm" value="${Doctor.docName}"></td>
                     </tr>
                     <tr>
                         <td>Department Name</td>
                         <td><input type="text" name="deptName" value="${Doctor.deptId}"></td>
                     </tr>  
                     <tr>
                         <td>Qualification</td>
         ...
         <a href="doc.htm">Click Here</a> to get Details Page.
    </center>
        </div>
        </div>
        <div id="clear"></div>
