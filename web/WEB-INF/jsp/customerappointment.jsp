<%-- 
    Document   : customerappointment
    Created on : Aug 3, 2017, 9:00:09 AM
    Author     : Bidesh
--%>
...
<html>
    <head>
        ...
        <title>All CUstomer's Appointment Details</title>
    ...
    <center>
        ...
        <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:black;font-style:italic;">
            ...
            <tr>
                ...
                <td><a href="editcustomerappo.htm?id=${customer.mrNo}"><font color="red">Edit</a></td>
                <td><a href="deletecustomerappo.htm?id=${customer.mrNo}"><font color="red">Delete</a></td> 
                </tr>
            </c:forEach>
        </table><br>
        <br>
