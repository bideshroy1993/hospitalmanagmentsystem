<%-- 
    Document   : department
    Created on : Jul 22, 2017, 11:17:24 AM
    Author     : Bidesh
--%>
 ...
 <center>
        ...
        <table id="t1" border="1">
            ...
            <tr>
                ...
                <td><a href="editdept.htm?id=${depertment.deptId}"><font color="red">Edit</a> </td> 
                <td><a href="deletedept.htm?id=${depertment.deptId}"><font color="red">Delete</a> </td> 
              </tr>
            </c:forEach>
        </table>
              <a href="adddept.htm">Click Here</a> to add new department
    </center>
        </div>
        </div>
        <div id="clear"></div>
