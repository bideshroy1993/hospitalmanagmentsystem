<%-- 
    Document   : updateeditcustomerappo
    Created on : Aug 8, 2017, 10:56:40 AM
    Author     : Bidesh
--%>
...
<html>
    <head>
        ...
        <title>Edit Customer Appointments</title>
                         <script>
function openNav() {
 ...
 <center>
        ...
        <c:choose>
            <c:when test="${not empty us}">
                <div id="search_id" >
                <form action="updatecustomerappo.htm" method="post">
                   <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:red;font-style:italic;">
                    <c:forEach items="${us}" var="Customerappo">
                                         
                    
                    <tr>
                         <td>MR. Number</td>
                         <td><input type="text" name="idd" value="${Customerappo.mrNo}"></td>
                     </tr>
                      <tr>
                         <td>Customer Name</td>
                         <td><input type="text" name="nm" value="${Customerappo.customerName}"></td>
                     </tr>
                     <tr>
                         <td>Contact No.</td>
                         <td><input type="text" name="ph" value="${Customerappo.contactNo}"></td>
                     </tr>  
                     <tr>
                         <td>Day</td>
                         <td><input type="text" name="day" value="${Customerappo.day}"></td>
                     </tr>  
                     <tr>
                         <td>Time</td>
                         <td><input type="text" name="time" value="${Customerappo.time}"></td>
                     </tr> 
                 </c:forEach>
                 </table><br/>
         ...
         <a href="customerappo.htm">Click Here</a> to get Customer Appointment Details.
    </center>
        </div>
        </div>
        <div id="clear"></div>
