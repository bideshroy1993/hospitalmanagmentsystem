<%-- 
    Document   : updateeditdept
    Created on : Aug 7, 2017, 6:00:59 PM
    Author     : Bidesh
--%>
...
function googleTranslateElementInit() {
 ...
 <center>
         <h1>${message}</h1><br>
        <c:choose>
            <c:when test="${not empty udept}">
                <div id="search_id" >
                <form action="updatedept.htm" method="post">
                   <table id="t1" border="1" style="font-family:Georgia, Garamond, Serif;color:red;font-style:italic;">
                    <c:forEach items="${udept}" var="Department">
                                          
                    
                    <tr>
                         <td>Department ID</td>
                         <td><input type="text" name="idd" value="${Department.deptId}"></td>
                     </tr>
                      <tr>
                         <td>Department Name</td>
                         <td><input type="text" name="nm" value="${Department.deptName}"></td>
                     </tr>   
                 </c:forEach>
                 </table><br/>
         ...
         <a href="dept.htm">Click Here</a> to get Details.
    </center>
        </div>
        </div>
        <div id="clear"></div>
