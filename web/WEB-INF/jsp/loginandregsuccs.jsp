<%-- 
    Document   : loginandregsuccs
    Created on : Aug 24, 2017, 10:59:42 AM
    Author     : Bidesh
--%>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'bn,en,hi,zh-CN'}, 'google_translate_element');
        ...
        <div id="welcomeadmin">
    <h1>Log In and Register successfully</h1>
    <br>
    <h3><a href="userbooking.htm"><input type="submit" value="Click Here to go to your profile" class="button" /></a></h3>
</div>
        </div>
          <div id="footerpart">
      <footer>
