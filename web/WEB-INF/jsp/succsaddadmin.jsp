<%-- 
    Document   : succsaddadmin
    Created on : Aug 16, 2017, 8:18:51 PM
    Author     : Bidesh
--%>
...
<div id="welcomeadmin">
    ...
    <br>
    <h3><a href="admindetails.htm"><input type="submit" value="Click Here to view details" class="button" /></a></h3>
</div>
        </div>
          <div id="footerpart">
      <footer>
